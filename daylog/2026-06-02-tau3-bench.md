...
**Agent:** Qwen3.6-35B-A3B (thinking off), temperature 0.2
**Judge:** claude-opus-4-5 — 3 dimensions (tool-use correctness, instruction following, KB grounding)
**Sample:** 10 runs × 30 turns = 300 turns per config; a turn passes only if all 3 dimensions pass

| Config | Pass Rate | Tool Use | Instruction | KB Grounding |
|---|---:|---:|---:|---:|
| Baseline | 91.7% (275/300) | 93.0% | 91.7% | 100% (300/300) |
| + 5-line prompt guard | **94.0%** (282/300) | 96.0% | 94.0% | 100% (300/300) |
